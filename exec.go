...
func (e *insertBuilder) Exec(s schema) error {
	sql, err := e.ToSQL(s)
	if err != nil {
		return err
	}
	_, err = e.h.NamedExec(sql.Query, s)
	return err
}
...
func (e *execUpdateBuilder) Exec(s schema) error {
	sql, err := e.ToSQL(s)
	if err != nil {
		return err
	}
...
func (e *execDeleteBuilder) Exec(s schema) error {
	sql, err := e.ToSQL(s)
	if err != nil {
		return err
	}
	_, err = e.h.Exec(sql.Query, sql.Args...)
	return err
}
